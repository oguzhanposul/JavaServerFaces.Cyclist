...
public String getNickname() {
    ...
    public ResultSet getOP() throws SQLException {
        ...
        PreparedStatement showEntry = connect.prepareStatement("SELECT * FROM CLUB");
    ...
    public void Insert() throws SQLException {
        ...
        Connection connect = DBConnection.DBAc();
        PreparedStatement addEntry = connect.prepareStatement("INSERT INTO CLUB (NAME,INFORMATION)"
                + "VALUES (?, ?)");        
